...
printint(int fd, int xx, int base, int sgn)
{
 ...
 451:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5a2:	75 28                	jne    5cc <printf+0x12e>
          s = "(null)";
 5a4:	be 89 07 00 00       	mov    $0x789,%esi
...
free(void *ap)
{
 ...
 61b:	a1 98 0a 00 00       	mov    0xa98,%eax
 ...
 657:	89 08                	mov    %ecx,(%eax)
  freep = p;
 659:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 6b6:	e8 50 ff ff ff       	call   60b <free>
  return freep;
 6bb:	a1 98 0a 00 00       	mov    0xa98,%eax
...
malloc(uint nbytes)
{
 ...
 6e3:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 6e6:	8b 0d 98 0a 00 00    	mov    0xa98,%ecx
 ...
 6f2:	eb 4b                	jmp    73f <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 6f4:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 6fb:	0a 00 00 
 6fe:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 705:	0a 00 00 
    base.s.size = 0;
 708:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 70f:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 712:	b9 9c 0a 00 00       	mov    $0xa9c,%ecx
 ...
 723:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 726:	89 0d 98 0a 00 00    	mov    %ecx,0xa98
      return (void*)(p + 1);
 ...
 744:	73 d3                	jae    719 <malloc+0x4a>
    if(p == freep)
 746:	39 05 98 0a 00 00    	cmp    %eax,0xa98
