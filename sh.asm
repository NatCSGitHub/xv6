...
setbuiltin(char *p)
{
  ...
  printf(2, "Invalid _set parameter\n");
      ...
      fb:	68 75 13 00 00       	push   $0x1375
     100:	6a 02                	push   $0x2
     102:	e8 a4 0f 00 00       	call   10ab <printf>
  return -1;
...
getbuiltin(char *p)
{
  ...
  p += strlen("_get");
     ...
     11d:	68 8d 13 00 00       	push   $0x138d
  ...
  while (strncmp(p, " ", 1) == 0) p++; // chomp spaces
     ...
     132:	6a 01                	push   $0x1
     134:	68 af 13 00 00       	push   $0x13af
     139:	53                   	push   %ebx
  ...
  if (strncmp("uid", p, 3) == 0) {
     ...
     14e:	6a 03                	push   $0x3
     150:	53                   	push   %ebx
     151:	68 6d 13 00 00       	push   $0x136d
  ...
  if (strncmp("gid", p, 3) == 0) {
     ...
     167:	6a 03                	push   $0x3
     169:	53                   	push   %ebx
     16a:	68 71 13 00 00       	push   $0x1371
    ...
    printf(2, "%d\n", getgid());
     ...
     185:	50                   	push   %eax
     186:	68 92 13 00 00       	push   $0x1392
     18b:	6a 02                	push   $0x2
     18d:	e8 19 0f 00 00       	call   10ab <printf>
    return 0;
  ...
  return -1;
    ...
    printf(2, "%d\n", getuid());
     ...
     1a6:	50                   	push   %eax
     1a7:	68 92 13 00 00       	push   $0x1392
     1ac:	6a 02                	push   $0x2
     1ae:	e8 f8 0e 00 00       	call   10ab <printf>
    return 0;
     1b3:	83 c4 10             	add    $0x10,%esp
     1b6:	eb dd                	jmp    195 <getbuiltin+0x84>
  printf(2, "Invalid _get parameter\n");
     1b8:	83 ec 08             	sub    $0x8,%esp
     1bb:	68 96 13 00 00       	push   $0x1396
     1c0:	6a 02                	push   $0x2
     1c2:	e8 e4 0e 00 00       	call   10ab <printf>
  return -1;
...
000001d1 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     1e3:	68 ae 13 00 00       	push   $0x13ae
     1e8:	6a 02                	push   $0x2
     1ea:	e8 bc 0e 00 00       	call   10ab <printf>
  memset(buf, 0, nbuf);
...
dobuiltin(char *cmd) {
  ...
  for (i=0; i<FDTcount; i++)
    ...
    if (strncmp(cmd, fdt[i].cmd, strlen(fdt[i].cmd)) == 0)
     ...
     268:	56                   	push   %esi
     269:	ff 14 dd 0c 1b 00 00 	call   *0x1b0c(,%ebx,8)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     289:	68 4b 14 00 00       	push   $0x144b
     28e:	6a 02                	push   $0x2
     290:	e8 16 0e 00 00       	call   10ab <printf>
  exit();
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     2b3:	68 b1 13 00 00       	push   $0x13b1
...
000002bd <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     2d6:	3e ff 24 85 6c 14 00 	notrack jmp *0x146c(,%eax,4)
     2dd:	00 
    exit();
     2de:	e8 37 0c 00 00       	call   f1a <exit>
    panic("runcmd");
     2e3:	83 ec 0c             	sub    $0xc,%esp
     2e6:	68 b6 13 00 00       	push   $0x13b6
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     30a:	68 bd 13 00 00       	push   $0x13bd
     30f:	6a 02                	push   $0x2
     311:	e8 95 0d 00 00       	call   10ab <printf>
    break;
  ...
  exit();
    ...
    runcmd(rcmd->cmd);
     ...
     354:	68 cd 13 00 00       	push   $0x13cd
     359:	6a 02                	push   $0x2
     35b:	e8 4b 0d 00 00       	call   10ab <printf>
      exit();
    ...
    break;
     ...
     3d9:	68 dd 13 00 00       	push   $0x13dd
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     472:	6a 54                	push   $0x54
     474:	e8 63 0e 00 00       	call   12dc <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     4a0:	6a 18                	push   $0x18
     4a2:	e8 35 0e 00 00       	call   12dc <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     4ec:	6a 0c                	push   $0xc
     4ee:	e8 e9 0d 00 00       	call   12dc <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     526:	6a 0c                	push   $0xc
     528:	e8 af 0d 00 00       	call   12dc <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     560:	6a 08                	push   $0x8
     562:	e8 75 0d 00 00       	call   12dc <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5ab:	50                   	push   %eax
     5ac:	68 fc 1a 00 00       	push   $0x1afc
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     627:	50                   	push   %eax
     628:	68 fc 1a 00 00       	push   $0x1afc
     ...
     63f:	50                   	push   %eax
     640:	68 f4 1a 00 00       	push   $0x1af4
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     673:	50                   	push   %eax
     674:	68 fc 1a 00 00       	push   $0x1afc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6b3:	50                   	push   %eax
     6b4:	68 fc 1a 00 00       	push   $0x1afc
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     71c:	68 e2 13 00 00       	push   $0x13e2
  ...
  while(peek(ps, es, "<>")){
     ...
     744:	68 ff 13 00 00       	push   $0x13ff
     749:	56                   	push   %esi
     74a:	57                   	push   %edi
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     7eb:	68 02 14 00 00       	push   $0x1402
     7f0:	57                   	push   %edi
     7f1:	56                   	push   %esi
  ...
  return ret;
     ...
     839:	68 04 14 00 00       	push   $0x1404
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     859:	68 19 14 00 00       	push   $0x1419
     85e:	57                   	push   %edi
     85f:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     8a3:	68 0b 14 00 00       	push   $0x140b
...
000008c5 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8e4:	68 1e 14 00 00       	push   $0x141e
     8e9:	57                   	push   %edi
     8ea:	56                   	push   %esi
...
00000927 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     949:	68 20 14 00 00       	push   $0x1420
     94e:	57                   	push   %edi
     94f:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     979:	68 1c 14 00 00       	push   $0x141c
     97e:	57                   	push   %edi
     97f:	56                   	push   %esi
...
000009bc <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     9cf:	68 02 14 00 00       	push   $0x1402
     9d4:	56                   	push   %esi
     9d5:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     9fc:	68 3e 14 00 00       	push   $0x143e
     a01:	56                   	push   %esi
     a02:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a60:	3e ff 24 85 84 14 00 	notrack jmp *0x1484(,%eax,4)
     a67:	00 
...
00000ae1 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     b0a:	68 95 13 00 00       	push   $0x1395
     b0f:	53                   	push   %ebx
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     b38:	50                   	push   %eax
     b39:	68 40 14 00 00       	push   $0x1440
     b3e:	6a 02                	push   $0x2
     b40:	e8 66 05 00 00       	call   10ab <printf>
    panic("syntax");
     b45:	c7 04 24 04 14 00 00 	movl   $0x1404,(%esp)
...
00000b51 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     b69:	6a 02                	push   $0x2
     b6b:	68 4f 14 00 00       	push   $0x144f
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     bd8:	68 57 14 00 00       	push   $0x1457
     bdd:	6a 02                	push   $0x2
     bdf:	e8 c7 04 00 00       	call   10ab <printf>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if ((buf[0] != '\n') && (strncmp(buf, "exit", strlen(buf)-1) == 0)) { // ignore '\n'
     ...
     c3c:	50                   	push   %eax
     c3d:	68 65 14 00 00       	push   $0x1465
...
SYSCALL(setpriority)
     ffa:	b8 1e 00 00 00       	mov    $0x1e,%eax
     fff:	cd 40                	int    $0x40
    1001:	c3                   	ret    

00001002 <getpriority>:
SYSCALL(getpriority)
    1002:	b8 1f 00 00 00       	mov    $0x1f,%eax
    1007:	cd 40                	int    $0x40
    1009:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    100d:	83 ec 1c             	sub    $0x1c,%esp
    1010:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    1013:	6a 01                	push   $0x1
    1015:	8d 55 f4             	lea    -0xc(%ebp),%edx
    1018:	52                   	push   %edx
    1019:	50                   	push   %eax
    101a:	e8 1b ff ff ff       	call   f3a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    102d:	89 45 d0             	mov    %eax,-0x30(%ebp)
    1030:	89 d6                	mov    %edx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    1032:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    1036:	0f 95 c2             	setne  %dl
    1039:	89 f0                	mov    %esi,%eax
    103b:	c1 e8 1f             	shr    $0x1f,%eax
    103e:	84 c2                	test   %al,%dl
    1040:	74 42                	je     1084 <printint+0x60>
    neg = 1;
    x = -xx;
    1042:	f7 de                	neg    %esi
    neg = 1;
    1044:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    104b:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
    1050:	89 f0                	mov    %esi,%eax
    1052:	ba 00 00 00 00       	mov    $0x0,%edx
    1057:	f7 f1                	div    %ecx
    1059:	89 df                	mov    %ebx,%edi
    105b:	83 c3 01             	add    $0x1,%ebx
    105e:	0f b6 92 a4 14 00 00 	movzbl 0x14a4(%edx),%edx
    1065:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
    1069:	89 f2                	mov    %esi,%edx
    106b:	89 c6                	mov    %eax,%esi
    106d:	39 d1                	cmp    %edx,%ecx
    106f:	76 df                	jbe    1050 <printint+0x2c>
  if(neg)
    1071:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    1075:	74 2f                	je     10a6 <printint+0x82>
    buf[i++] = '-';
    1077:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    107c:	8d 5f 02             	lea    0x2(%edi),%ebx
    107f:	8b 75 d0             	mov    -0x30(%ebp),%esi
    1082:	eb 15                	jmp    1099 <printint+0x75>
  neg = 0;
    1084:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    108b:	eb be                	jmp    104b <printint+0x27>

  while(--i >= 0)
    putc(fd, buf[i]);
    108d:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    1092:	89 f0                	mov    %esi,%eax
    1094:	e8 71 ff ff ff       	call   100a <putc>
  while(--i >= 0)
    1099:	83 eb 01             	sub    $0x1,%ebx
    109c:	79 ef                	jns    108d <printint+0x69>
}
    109e:	83 c4 2c             	add    $0x2c,%esp
    10a1:	5b                   	pop    %ebx
    10a2:	5e                   	pop    %esi
    10a3:	5f                   	pop    %edi
    10a4:	5d                   	pop    %ebp
    10a5:	c3                   	ret    
    10a6:	8b 75 d0             	mov    -0x30(%ebp),%esi
    10a9:	eb ee                	jmp    1099 <printint+0x75>
...
printf(int fd, char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    10b8:	8d 45 10             	lea    0x10(%ebp),%eax
    10bb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    10be:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    10c3:	bb 00 00 00 00       	mov    $0x0,%ebx
    10c8:	eb 14                	jmp    10de <printf+0x33>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    10ca:	89 fa                	mov    %edi,%edx
    10cc:	8b 45 08             	mov    0x8(%ebp),%eax
    10cf:	e8 36 ff ff ff       	call   100a <putc>
    10d4:	eb 05                	jmp    10db <printf+0x30>
      }
    } else if(state == '%'){
    10d6:	83 fe 25             	cmp    $0x25,%esi
    10d9:	74 25                	je     1100 <printf+0x55>
  for(i = 0; fmt[i]; i++){
    10db:	83 c3 01             	add    $0x1,%ebx
    10de:	8b 45 0c             	mov    0xc(%ebp),%eax
    10e1:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    10e5:	84 c0                	test   %al,%al
    10e7:	0f 84 23 01 00 00    	je     1210 <printf+0x165>
    c = fmt[i] & 0xff;
    10ed:	0f be f8             	movsbl %al,%edi
    10f0:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    10f3:	85 f6                	test   %esi,%esi
    10f5:	75 df                	jne    10d6 <printf+0x2b>
      if(c == '%'){
    10f7:	83 f8 25             	cmp    $0x25,%eax
    10fa:	75 ce                	jne    10ca <printf+0x1f>
        state = '%';
    10fc:	89 c6                	mov    %eax,%esi
    10fe:	eb db                	jmp    10db <printf+0x30>
      if(c == 'd'){
    1100:	83 f8 64             	cmp    $0x64,%eax
    1103:	74 49                	je     114e <printf+0xa3>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1105:	83 f8 78             	cmp    $0x78,%eax
    1108:	0f 94 c1             	sete   %cl
    110b:	83 f8 70             	cmp    $0x70,%eax
    110e:	0f 94 c2             	sete   %dl
    1111:	08 d1                	or     %dl,%cl
    1113:	75 63                	jne    1178 <printf+0xcd>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    1115:	83 f8 73             	cmp    $0x73,%eax
    1118:	0f 84 84 00 00 00    	je     11a2 <printf+0xf7>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    111e:	83 f8 63             	cmp    $0x63,%eax
    1121:	0f 84 b7 00 00 00    	je     11de <printf+0x133>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    1127:	83 f8 25             	cmp    $0x25,%eax
    112a:	0f 84 cc 00 00 00    	je     11fc <printf+0x151>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    1130:	ba 25 00 00 00       	mov    $0x25,%edx
    1135:	8b 45 08             	mov    0x8(%ebp),%eax
    1138:	e8 cd fe ff ff       	call   100a <putc>
        putc(fd, c);
    113d:	89 fa                	mov    %edi,%edx
    113f:	8b 45 08             	mov    0x8(%ebp),%eax
    1142:	e8 c3 fe ff ff       	call   100a <putc>
      }
      state = 0;
    1147:	be 00 00 00 00       	mov    $0x0,%esi
    114c:	eb 8d                	jmp    10db <printf+0x30>
        printint(fd, *ap, 10, 1);
    114e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    1151:	8b 17                	mov    (%edi),%edx
    1153:	83 ec 0c             	sub    $0xc,%esp
    1156:	6a 01                	push   $0x1
    1158:	b9 0a 00 00 00       	mov    $0xa,%ecx
    115d:	8b 45 08             	mov    0x8(%ebp),%eax
    1160:	e8 bf fe ff ff       	call   1024 <printint>
        ap++;
    1165:	83 c7 04             	add    $0x4,%edi
    1168:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    116b:	83 c4 10             	add    $0x10,%esp
      state = 0;
    116e:	be 00 00 00 00       	mov    $0x0,%esi
    1173:	e9 63 ff ff ff       	jmp    10db <printf+0x30>
        printint(fd, *ap, 16, 0);
    1178:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    117b:	8b 17                	mov    (%edi),%edx
    117d:	83 ec 0c             	sub    $0xc,%esp
    1180:	6a 00                	push   $0x0
    1182:	b9 10 00 00 00       	mov    $0x10,%ecx
    1187:	8b 45 08             	mov    0x8(%ebp),%eax
    118a:	e8 95 fe ff ff       	call   1024 <printint>
        ap++;
    118f:	83 c7 04             	add    $0x4,%edi
    1192:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    1195:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1198:	be 00 00 00 00       	mov    $0x0,%esi
    119d:	e9 39 ff ff ff       	jmp    10db <printf+0x30>
        s = (char*)*ap;
    11a2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    11a5:	8b 30                	mov    (%eax),%esi
        ap++;
    11a7:	83 c0 04             	add    $0x4,%eax
    11aa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    11ad:	85 f6                	test   %esi,%esi
    11af:	75 28                	jne    11d9 <printf+0x12e>
          s = "(null)";
    11b1:	be 9c 14 00 00       	mov    $0x149c,%esi
    11b6:	8b 7d 08             	mov    0x8(%ebp),%edi
    11b9:	eb 0d                	jmp    11c8 <printf+0x11d>
          putc(fd, *s);
    11bb:	0f be d2             	movsbl %dl,%edx
    11be:	89 f8                	mov    %edi,%eax
    11c0:	e8 45 fe ff ff       	call   100a <putc>
          s++;
    11c5:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    11c8:	0f b6 16             	movzbl (%esi),%edx
    11cb:	84 d2                	test   %dl,%dl
    11cd:	75 ec                	jne    11bb <printf+0x110>
      state = 0;
    11cf:	be 00 00 00 00       	mov    $0x0,%esi
    11d4:	e9 02 ff ff ff       	jmp    10db <printf+0x30>
    11d9:	8b 7d 08             	mov    0x8(%ebp),%edi
    11dc:	eb ea                	jmp    11c8 <printf+0x11d>
        putc(fd, *ap);
    11de:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    11e1:	0f be 17             	movsbl (%edi),%edx
    11e4:	8b 45 08             	mov    0x8(%ebp),%eax
    11e7:	e8 1e fe ff ff       	call   100a <putc>
        ap++;
    11ec:	83 c7 04             	add    $0x4,%edi
    11ef:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    11f2:	be 00 00 00 00       	mov    $0x0,%esi
    11f7:	e9 df fe ff ff       	jmp    10db <printf+0x30>
        putc(fd, c);
    11fc:	89 fa                	mov    %edi,%edx
    11fe:	8b 45 08             	mov    0x8(%ebp),%eax
    1201:	e8 04 fe ff ff       	call   100a <putc>
      state = 0;
    1206:	be 00 00 00 00       	mov    $0x0,%esi
    120b:	e9 cb fe ff ff       	jmp    10db <printf+0x30>
    }
  }
}
...
free(void *ap)
{
    ...
    1220:	56                   	push   %esi
    1221:	53                   	push   %ebx
    1222:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1225:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1228:	a1 84 1b 00 00       	mov    0x1b84,%eax
    122d:	eb 02                	jmp    1231 <free+0x19>
    122f:	89 d0                	mov    %edx,%eax
    1231:	39 c8                	cmp    %ecx,%eax
    1233:	73 04                	jae    1239 <free+0x21>
    1235:	39 08                	cmp    %ecx,(%eax)
    1237:	77 12                	ja     124b <free+0x33>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1239:	8b 10                	mov    (%eax),%edx
    123b:	39 c2                	cmp    %eax,%edx
    123d:	77 f0                	ja     122f <free+0x17>
    123f:	39 c8                	cmp    %ecx,%eax
    1241:	72 08                	jb     124b <free+0x33>
    1243:	39 ca                	cmp    %ecx,%edx
    1245:	77 04                	ja     124b <free+0x33>
    1247:	89 d0                	mov    %edx,%eax
    1249:	eb e6                	jmp    1231 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    124b:	8b 73 fc             	mov    -0x4(%ebx),%esi
    124e:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    1251:	8b 10                	mov    (%eax),%edx
    1253:	39 d7                	cmp    %edx,%edi
    1255:	74 19                	je     1270 <free+0x58>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    1257:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    125a:	8b 50 04             	mov    0x4(%eax),%edx
    125d:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    1260:	39 ce                	cmp    %ecx,%esi
    1262:	74 1b                	je     127f <free+0x67>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    1264:	89 08                	mov    %ecx,(%eax)
  freep = p;
    1266:	a3 84 1b 00 00       	mov    %eax,0x1b84
}
    126b:	5b                   	pop    %ebx
    126c:	5e                   	pop    %esi
    126d:	5f                   	pop    %edi
    ...
    126f:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    1270:	03 72 04             	add    0x4(%edx),%esi
    1273:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    1276:	8b 10                	mov    (%eax),%edx
    1278:	8b 12                	mov    (%edx),%edx
    127a:	89 53 f8             	mov    %edx,-0x8(%ebx)
    127d:	eb db                	jmp    125a <free+0x42>
    p->s.size += bp->s.size;
    127f:	03 53 fc             	add    -0x4(%ebx),%edx
    1282:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    1285:	8b 53 f8             	mov    -0x8(%ebx),%edx
    1288:	89 10                	mov    %edx,(%eax)
    128a:	eb da                	jmp    1266 <free+0x4e>
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    1295:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    129a:	77 05                	ja     12a1 <morecore+0x15>
    nu = 4096;
    129c:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    12a1:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    12a8:	83 ec 0c             	sub    $0xc,%esp
    12ab:	50                   	push   %eax
    12ac:	e8 f1 fc ff ff       	call   fa2 <sbrk>
  if(p == (char*)-1)
    12b1:	83 c4 10             	add    $0x10,%esp
    12b4:	83 f8 ff             	cmp    $0xffffffff,%eax
    12b7:	74 1c                	je     12d5 <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    12b9:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    12bc:	83 c0 08             	add    $0x8,%eax
    12bf:	83 ec 0c             	sub    $0xc,%esp
    12c2:	50                   	push   %eax
    12c3:	e8 50 ff ff ff       	call   1218 <free>
  return freep;
    12c8:	a1 84 1b 00 00       	mov    0x1b84,%eax
    ...
    12da:	eb f4                	jmp    12d0 <morecore+0x44>
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    12ea:	8d 58 07             	lea    0x7(%eax),%ebx
    12ed:	c1 eb 03             	shr    $0x3,%ebx
    12f0:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    12f3:	8b 0d 84 1b 00 00    	mov    0x1b84,%ecx
    12f9:	85 c9                	test   %ecx,%ecx
    12fb:	74 04                	je     1301 <malloc+0x25>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12fd:	8b 01                	mov    (%ecx),%eax
    12ff:	eb 4b                	jmp    134c <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
    1301:	c7 05 84 1b 00 00 88 	movl   $0x1b88,0x1b84
    1308:	1b 00 00 
    130b:	c7 05 88 1b 00 00 88 	movl   $0x1b88,0x1b88
    1312:	1b 00 00 
    base.s.size = 0;
    1315:	c7 05 8c 1b 00 00 00 	movl   $0x0,0x1b8c
    131c:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    131f:	b9 88 1b 00 00       	mov    $0x1b88,%ecx
    1324:	eb d7                	jmp    12fd <malloc+0x21>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    1326:	74 1a                	je     1342 <malloc+0x66>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    1328:	29 da                	sub    %ebx,%edx
    132a:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    132d:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    1330:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    1333:	89 0d 84 1b 00 00    	mov    %ecx,0x1b84
      return (void*)(p + 1);
    ...
    133c:	83 c4 04             	add    $0x4,%esp
    133f:	5b                   	pop    %ebx
    1340:	5d                   	pop    %ebp
    1341:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    1342:	8b 10                	mov    (%eax),%edx
    1344:	89 11                	mov    %edx,(%ecx)
    1346:	eb eb                	jmp    1333 <malloc+0x57>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1348:	89 c1                	mov    %eax,%ecx
    134a:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    134c:	8b 50 04             	mov    0x4(%eax),%edx
    134f:	39 da                	cmp    %ebx,%edx
    1351:	73 d3                	jae    1326 <malloc+0x4a>
    if(p == freep)
    1353:	39 05 84 1b 00 00    	cmp    %eax,0x1b84
    1359:	75 ed                	jne    1348 <malloc+0x6c>
      if((p = morecore(nunits)) == 0)
    135b:	89 d8                	mov    %ebx,%eax
    135d:	e8 2a ff ff ff       	call   128c <morecore>
    1362:	85 c0                	test   %eax,%eax
    1364:	75 e2                	jne    1348 <malloc+0x6c>
    1366:	eb d4                	jmp    133c <malloc+0x60>
