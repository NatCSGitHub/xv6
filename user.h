...
#endif //CS333_P1
//attempting to put all under one ifdef 		//p2
#ifdef CS333_P2
...
int getprocs(uint, struct uproc*); 	//what does this doooooooo
#endif //CS333_P2
#ifdef CS333_P4
int setpriority(int pid, int priority);   //set priority
int getpriority(int pid);                 //get priority
#endif //CS333_P4
